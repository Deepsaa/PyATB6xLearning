...
greet_by_name("Deepsa")


# 3. No Return Type and with Default Argument ( # positional argument)
def say_hello_default_arg(name="Deepsa"):
    print("Hello", name.upper())


say_hello_default_arg("Sahu")
...
multiple_args()
multiple_args("Byom", "Mohanty")
multiple_args(name1="Deepsa")
multiple_args(name1="Mohanty", name2="Varenyam")
multiple_args(name2="Varenyam")
